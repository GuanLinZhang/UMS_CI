...
<div class="page__hd">
    <h1 class="page__title" style="text-align: center;">注册</h1>
</div>
<div class="page__bd">
    ...
    <div class="weui-btn-area">
        <button class="weui-btn weui-btn_primary" id="registerBtn" style="float: right; margin-top: 0px;">注册</button>
        <button class="weui-btn weui-btn_cell-primary" id="goBackBtn" style="float: left; margin-top: 0px;">返回</button>
    </div>
</div>
<script>
    ...
    $(function () {
        document.title = "注册";
        console.log("fuc",document.title);
        $("#registerBtn").on("click",registerBtnClicked);
